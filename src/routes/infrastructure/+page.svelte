...
<svelte:head>
  ...
  <meta
    name="description"
    content="ภาพรวมโครงสร้างพื้นฐาน CSNIS: Network edge, Core, Wireless และ Server Network"
  />
</svelte:head>
...
<div class="container">
  <PageHeader
    ...
    description="ภาพรวมองค์ประกอบเครือข่าย ตั้งแต่ Network Edge ไปจนถึงระบบภายในองค์กร"
  />
  <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
    <!-- <span
      class="rounded-md border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700"
      >LIVE SYNCED · ข้อมูลซิงค์ตามหน้า Live Topology</span
    > -->
